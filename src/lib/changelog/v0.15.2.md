...
- Centralize daemon prompt modal for new organizations, so first-time setup is less confusing ([#196](https://github.com/scanopy/scanopy/pull/196)).
  
  ![Daemon prompt modal for new organization setup](/changelog/v0.15.2/daemon-prompt.png)
...
- Remove stray symbol from daemon delete confirmation for a cleaner user message ([#203](https://github.com/scanopy/scanopy/pull/203)).
