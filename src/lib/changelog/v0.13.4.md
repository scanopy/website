...
- Fix server-side ordering for grouped pagination, resulting in correctly sorted lists when viewing network assets in groups ([#450](https://github.com/scanopy/scanopy/pull/450))
