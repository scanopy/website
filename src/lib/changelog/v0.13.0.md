...
- Add security headers to prevent clickjacking and MIME sniffing attacks, strengthening protection against common web vulnerabilities ([#421](https://github.com/scanopy/scanopy/pull/421)).
