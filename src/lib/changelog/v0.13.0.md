...
social_post: • User API keys with granular permissions and network scoping\n• API versioning and key access tied to billing plans\n• Improved agent connection reliability\n• Added security headers to prevent clickjacking and MIME sniffing\n• UI sorting preferences saved automatically
contributors: Maya
---
...
- Add security headers to prevent clickjacking and MIME sniffing, enhancing platform security for all users ([#421](https://github.com/scanopy/scanopy/pull/421)).
