...
The [Community Edition](/community) is free and self-hosted. The [commercial editions](/commercial) remove the seat and network limits and add support, and [pricing](/pricing) covers the plan tiers. For a neighboring obligation, see the guide to [network documentation for NIS2](/guides/network-documentation-nis2), and for the broader category, the guide to [network documentation software](/guides/network-documentation-software).
