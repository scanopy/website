...
The open-source tools here are all narrower than the full field. If you want to weigh them against the commercial tools too, with pricing and discovery method side by side, see the full comparison of [network diagram tools](/comparisons/best-automated-network-diagram-tools).
