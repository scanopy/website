...
>
	<section>
		...
		<p class="mb-4 text-gray-300">
			...
			("Scanopy," "we," "us," or "our") collects, uses, and discloses your personal information when
			you use our software as a service (the "Service").
		</p>
		<p class="mb-4 text-gray-300">
			We are committed to protecting your personal information and your right to privacy. When you
			visit our software as a service and use our products, you trust us with your personal
			information. We take your privacy very seriously. In this Privacy Policy, we seek to explain
			to you in the clearest way possible what information we collect, how we use it, and what
	...
	<section>
		...
		<ul class="list-inside list-disc space-y-2 text-gray-300">
			<li>
				<strong class="text-white">Cookie:</strong> a small file placed on your device to enable certain
			...
			<li>
				<strong class="text-white">Device:</strong> any internet-connected device such as a phone, tablet,
				computer, or any other device that can be used to visit Scanopy and use the services.
			</li>
			<li>
				<strong class="text-white">Personal Data:</strong> any information that directly, indirectly,
				or in connection with other information allows for the identification of a natural person.
			</li>
			<li>
				<strong class="text-white">Service:</strong> refers to the software as a service provided by
				Scanopy as described in the relative terms and on this platform.
			</li>
			<li>
				<strong class="text-white">Third-party service:</strong> refers to advertisers, contest sponsors,
				promotional and marketing partners, and others who provide our content or whose products or services
			...
			<li>
				<strong class="text-white">You:</strong> a person or entity that is registered with Scanopy to
				use the Services.
			</li>
		</ul>
	</section>
	...
	<section>
		<h2 class="mb-4 text-2xl font-semibold text-rose-400">3. Information We Collect</h2>
		<p class="mb-4 text-gray-300">
			We collect several different types of information for various purposes to provide and improve
			our Service to you.
		</p>

		<h3 class="mb-3 text-xl font-semibold text-white">3.1 Personal Data</h3>
		<p class="mb-4 text-gray-300">
		...
		<h3 class="mb-3 text-xl font-semibold text-white">3.2 Usage Data</h3>
		...
		<h3 class="mb-3 text-xl font-semibold text-white">3.3 Tracking Technologies and Cookies</h3>
		<p class="mb-4 text-gray-300">
		...
		<p class="mb-2 text-gray-300">Examples of Cookies we use:</p>
		<ul class="list-inside list-disc space-y-1 text-gray-300">
			<li>
				<strong class="text-white">Session Cookies:</strong> We use Session Cookies to operate our Service.
			</li>
			<li>
				<strong class="text-white">Preference Cookies:</strong> We use Preference Cookies to remember
	...
	<section>
		<h2 class="mb-4 text-2xl font-semibold text-rose-400">5. Retention of Your Personal Data</h2>
		<p class="mb-4 text-gray-300">
			Scanopy will retain your Personal Data only for as long as is necessary for the purposes set
		...
		<p class="mb-4 text-gray-300">
			Scanopy will also retain Usage Data for internal analysis purposes. Usage Data is generally
		...
		<p class="text-gray-300">
			For orders involving physical goods, we retain your shipping and billing information,
			including your name, address, and contact details, as necessary to fulfill your order, process
			returns, manage warranty claims, and comply with tax, legal, and regulatory obligations. This
			information may be retained for a longer period than other personal data to ensure proper
	...
	<section>
		...
		<p class="text-gray-300">
			Scanopy will take all steps reasonably necessary to ensure that your data is treated securely
	...
	<section>
		<h2 class="mb-4 text-2xl font-semibold text-rose-400">7. Disclosure of Your Personal Data</h2>
		...
		<p class="mb-2 text-gray-300">
			Scanopy may disclose your Personal Data in the good faith belief that such action is necessary
			to:
		</p>
		<ul class="list-inside list-disc space-y-1 text-gray-300">
	...
	<section>
		<h2 class="mb-4 text-2xl font-semibold text-rose-400">8. Third-Party Disclosure</h2>

		<h3 class="mb-3 text-xl font-semibold text-white">8.1 Payments</h3>
		<p class="mb-4 text-gray-300">
		...
		<p class="mb-2 text-gray-300">The payment processors we work with are:</p>
		<ul class="mb-6 list-inside list-disc space-y-1 text-gray-300">
			<li>
				<strong class="text-white">Stripe:</strong>
				<a
	...
	<section>
		<h2 class="mb-4 text-2xl font-semibold text-rose-400">9. Security of Your Personal Data</h2>
		<p class="text-gray-300">
	...
	<section>
		<h2 class="mb-4 text-2xl font-semibold text-rose-400">10. Children's Privacy</h2>
		<p class="mb-4 text-gray-300">
	...
	<section>
		<h2 class="mb-4 text-2xl font-semibold text-rose-400">11. Your Data Protection Rights</h2>
		<p class="mb-4 text-gray-300">
			Depending on your location and applicable laws, you may have certain rights regarding your
			personal information, including rights to access, correct, delete, or restrict use of your
			information. We honor these rights regardless of your location and are committed to providing
			reasonable access to the information that you have shared with us.
		</p>

		<h3 class="mb-3 text-xl font-semibold text-white">
			11.1 General Data Access & Deletion Rights
		</h3>
		<p class="mb-2 text-gray-300">
		...
		<ul class="mb-4 list-inside list-disc space-y-2 text-gray-300">
			<li>
				<strong class="text-white">Access Your Data:</strong> You can request a copy of the personal
				information we have about you. We will provide this information in a structured, commonly used,
				and machine-readable format.
			</li>
			<li>
				<strong class="text-white">Delete Your Data:</strong> You can request that we delete your personal
				information from our systems. We will comply with this request unless there is a legal requirement
		...
		<h3 class="mb-3 text-xl font-semibold text-white">
			11.2 CCPA Privacy Rights (California Residents)
		</h3>
		<p class="mb-4 text-gray-300">
			...
			you can make certain requests and ask us:
		</p>
		<ul class="mb-4 list-inside list-disc space-y-2 text-gray-300">
			<li>
				What personal information we have about you, including categories of information, sources,
	...
	<section>
		<h2 class="mb-4 text-2xl font-semibold text-rose-400">12. Service Providers</h2>
		<p class="text-gray-300">
	...
	<section>
		<h2 class="mb-4 text-2xl font-semibold text-rose-400">13. Links to Other Sites</h2>
		<p class="mb-4 text-gray-300">
	...
	<section>
		<h2 class="mb-4 text-2xl font-semibold text-rose-400">14. Changes to This Privacy Policy</h2>
		<p class="mb-4 text-gray-300">
	...
	<section>
		<h2 class="mb-4 text-2xl font-semibold text-rose-400">15. Contact Us</h2>
		<p class="mb-4 text-gray-300">
