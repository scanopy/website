...
<Callout type="info">
[Book a demo](https://cal.com/mferrandiz/scanopy-demo) to walk through the commercial edition with us, or contact [licensing@scanopy.net](mailto:licensing@scanopy.net) to get a license key. The [pricing page](https://scanopy.net/pricing) lists what each self-hosted tier includes.
</Callout>
