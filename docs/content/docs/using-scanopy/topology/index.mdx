...
On a topology with 1,000 or more nodes, zooming out switches nodes to a simplified, reduced-detail form rather than rendering every card in full. A brief loading indicator appears while this is computed. Zoom back in to return to full detail.
