...
| ---- | ---------------- |
| **SNMP** | Device identity, interfaces, LLDP/CDP neighbors via SNMPv1, v2c, or v3 (AuthPriv) |
...
After the daemon's first scan discovers hosts at those IPs, the credentials are [auto-assigned](/using-scanopy/credentials/#auto-assignment) to the matching hosts and used in subsequent scans without manual assignment.
