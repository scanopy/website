...
See [Set up SNMP discovery](/guides/integrations/snmp/), [Set up Docker discovery](/guides/integrations/docker/), and [Set up Podman discovery](/guides/integrations/podman/) for setup instructions.
