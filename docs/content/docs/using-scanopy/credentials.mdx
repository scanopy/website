...
After the daemon's first scan discovers hosts at those IPs, the credentials are automatically assigned to the matching hosts and used in subsequent scans without manual assignment.
