...
See [Virtualization Relationships](/using-scanopy/network-data/#virtualization-relationships).
...
See [Groups](/using-scanopy/network-data/#groups).

### Manage External Dependencies

The default **Internet** and **Remote Network** subnets at the top of your topology are for tracking external services. Add your external dependencies there, or delete these subnets via **Assets > Subnets** if you don't need them.

See [Organizational Subnets](/using-scanopy/network-data/#organizational-subnets).
