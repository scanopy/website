...
**Benchmark**: A /24 subnet typically takes around **30 minutes** to scan with Layer 2 access. Duration depends primarily on the number of active hosts on the network.
