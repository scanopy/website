...
See [Installing a Daemon](/installing-daemon/) for platform-specific information.
...
A running Scanopy server. See [Server Installation](/server-installation/).
...
To scan additional networks or VLANs, deploy additional daemons. See [Multi-VLAN Deployment](/multi-vlan/).

---

## Next Steps

- [Discovery](/discovery/) — Configure scheduled scans
- [Topology](/topology/) — Customize your network visualization
- [Hosts, Subnets & Groups](/network-data/) — Organize your network data
