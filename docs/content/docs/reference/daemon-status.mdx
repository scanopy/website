...
- Upgrade the daemon before the sunset date — see [Managing Daemons](/setting-up-daemons/managing-daemons) for installation steps. See [Daemon Support Lifecycle](/reference/daemon-support-lifecycle) for how sunset dates are set.
