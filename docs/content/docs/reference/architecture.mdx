...
flowchart TD
    ...
    subgraph step4["4. Daemon executes discovery"]
        scan1["Network scanning:<br/>Scans IP range, detects ports/services"]
        scan2["Docker scanning:<br/>Queries Docker API for containers"]
        scan3["Self-report:<br/>Reports interfaced subnets"]
    end
