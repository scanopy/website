...
- **Self-hosted / enterprise managed**: Any OIDC-compliant provider can be configured, including Authentik, Keycloak, Auth0, and Okta. See the [OIDC configuration guide](/guides/oidc) for setup instructions.
