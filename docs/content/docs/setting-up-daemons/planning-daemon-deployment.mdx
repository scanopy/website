...
- **Remote subnets**: The daemon can scan subnets it can route to but doesn't have an interface on (Layer 3 only). See [Scanning Remote Subnets](/guides/scanning-remote-subnets/).
