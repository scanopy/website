...
2. **Integrations** — optionally add [credentials](/using-scanopy/credentials/#attaching-a-credential), targeting all hosts or specific ones. They're [auto-assigned](/using-scanopy/credentials/#auto-assignment) to discovered hosts after the first scan.
