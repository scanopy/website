...
- For SNMP, verify the community string works from the daemon host using `snmpwalk` — see [Verify device responds to SNMPv2c](/setting-up-daemons/troubleshooting-scans/snmp/#verify-device-responds-to-snmpv2c)
