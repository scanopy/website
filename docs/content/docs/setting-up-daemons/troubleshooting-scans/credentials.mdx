...
3. **The credential isn't assigned** to any network or host — see [Credential assignment](/using-scanopy/credentials/#attaching-a-credential)
...
- For SNMP, verify the credential works from the daemon host using `snmpwalk` — see [SNMP troubleshooting](/guides/integrations/snmp/#troubleshooting)
