...
- For Docker Proxy, verify the proxy is reachable and the certificate is accepted — see [Docker Proxy troubleshooting](/guides/integrations/docker/#troubleshooting)
