...
If a single host has interfaces on multiple VLANs, you can run several daemon instances on that one machine — see [Multiple Daemons on One Host](/docs/multiple-daemons).
