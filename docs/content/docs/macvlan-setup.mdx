---
title: MACVLAN Networking
description: Deploy the Scanopy daemon with Docker MACVLAN for network isolation.
---
...
MACVLAN works with the strategies in [Multi-VLAN Deployment](/multi-vlan/). Deploy one MACVLAN daemon per VLAN for full Layer 2 access on each segment.
