...
- Switch the daemon to ServerPoll mode — see [Installing a Daemon](/docs/installing-daemon) for mode details
...
- Upgrade the daemon to the latest version immediately — see [Installing a Daemon](/docs/installing-daemon) for installation steps
...
- Upgrade the daemon at your convenience — see [Installing a Daemon](/docs/installing-daemon) for installation steps
...
For more help, see [Daemon Troubleshooting](/docs/troubleshooting/daemon) and [Installing a Daemon](/docs/installing-daemon).
