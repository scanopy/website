...
- **Self-hosted users**: Start with [Installing Scanopy (Self-Hosted)](/self-hosted-server/server-installation/), then continue to [Quick Start](/quick-start/)
- **Cloud users**: Continue to [Quick Start](/quick-start/#cloud)
