...
Self-hosted users need to install the Scanopy server before deploying daemons. See the [Self-Hosted](/server-installation/) section for setup instructions.
...
- **Self-hosted users**: Start with [Server Installation](/server-installation/), then return to Quick Start
