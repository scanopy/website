...
<IntegrationBeta id="UniFi Controller">
	The per-device tables this integration reads — switch ports, LLDP neighbors, and bridge
	forwarding entries — have not yet been confirmed against a broad range of UniFi hardware.
</IntegrationBeta>
