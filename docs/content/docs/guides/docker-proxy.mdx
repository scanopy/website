...
The daemon connects to the Docker socket on its own host.
...
The daemon connects to a proxy that restricts Docker API operations.

**Use when:**

- You want to restrict Docker API operations
- You need to discover containers on a remote host
